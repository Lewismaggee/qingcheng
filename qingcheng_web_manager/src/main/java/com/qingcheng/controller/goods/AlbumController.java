...
public class AlbumController {
    ...
    @PostMapping("/updateImageItems")
    public Result updateImageItems(@RequestBody Album album){
        albumService.updateImageItems(album);
        return new Result();
    }
    ...
    public Result deleteImage(@RequestBody Album album){
