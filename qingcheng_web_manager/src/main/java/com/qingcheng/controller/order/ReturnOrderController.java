...
public class ReturnOrderController {
    ...
    @GetMapping("/agreeResale")
    public Result agreeReSale(String id){
        returnOrderService.agreeReSale(id);
        return new Result();
    }

    @GetMapping("/rejectResale")
    public Result rejectResale(String id){
        returnOrderService.rejectResale(id);
        return new Result();
    }
